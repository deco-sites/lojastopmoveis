...
const handleSetScope = () => {
    ...
    // @ts-expect-error
    window.vtexid.setScope("c1c1fe96-68b5-4ed4-ae14-4fb70736a438");
    // deno-lint-ignore ban-ts-comment
    // @ts-expect-error
    window.vtexid.setScopeName("topmoveis");
};
...
export const loadVtexIdScripts = (callback: () => void) => {
    ...
    /*LOGIN ESTILIZADO:*/
          ...
          #vtexIdUI-global-loader {
            ...
            background: white url(https://topmoveis.vteximg.com.br/arquivos/loading-topmoveis.gif) no-repeat center center !important;
          ...
          button#loginWithAccessKeyBtn::after {
            content: '';
            display: block;
            background: url("https://topmoveis.vteximg.com.br/arquivos/mail.png") no-repeat;
            display: block;
            height: 20px;
            width: 35px;
            position: absolute;
          ...
          .vtexIdUI #vtexIdUI-google-plus::after {
            content: '';
            display: block;
            background: url("https://topmoveis.vteximg.com.br/arquivos/gplus.png") no-repeat;
            display: block;
            height: 30px;
            width: 39px;
            position: absolute;
          ...
          .vtexIdUI #vtexIdUI-facebook::after {
            content: '';
            display: block;
            background: url("https://topmoveis.vteximg.com.br/arquivos/facebookicon.png") no-repeat;
            display: block;
            height: 30px;
            width: 30px;
            position: absolute;
          ...
          button#loginWithUserAndPasswordBtn::after {
            content: '';
            display: block;
            background: url("https://topmoveis.vteximg.com.br/arquivos/lock.png") no-repeat;
            height: 30px;
            width: 39px;
            position: absolute;
            top: 21%;
          ...
          .vtexIdUI-back-link .vtexid-icon-arrow-left {
            color: grey;
            background: url(https://topmoveis.vteximg.com.br/arquivos/arrow-left.png) no-repeat;
