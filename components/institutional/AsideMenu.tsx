...
function AsideMenu({ menuItems, pathname: currentUrl }: SectionProps<typeof loader>) {
    ...
    return (<aside class="md:min-w-[100%] font-medium text-secondary-focus flex md:justify-end">
      <ul class={`md:join join-vertical gap-[10px] w-full ${currentUrl === "/i" ? "" : "hidden"}`}>
