...
function ProductShelf({ products, title, layout, cardLayout, seeMore, showPaginationArrows, highlights, tags, device }: Props) {
  ...
  return (<div class="w-full pb-8 flex flex-col lg:gap-7 lg:pb-10">
    ...
    <div id={id+customId} class="grid grid-cols-[48px_1fr_48px] px-0 grid-rows-[1fr_48px_1fr_48px]">
      ...
      <>
        <div class={`flex items-center justify-center z-20  col-start-1 row-start-2 max-md:w-0 ${CONDITIONAL_RESPONSIVE_PARAMS[showPaginationArrows ? showPaginationArrows : "Always"]}`}>
        ...
        <div class={`flex items-center justify-center z-20 col-start-3 row-start-2 max-md:pl-[40px] ${CONDITIONAL_RESPONSIVE_PARAMS[showPaginationArrows ? showPaginationArrows : "Always"]}`}>
